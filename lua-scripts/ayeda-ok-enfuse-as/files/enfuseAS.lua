--[[Enfuse Advanced plugin for darktable 2.2.X and 2.4.X
  ...
  Modified by: Kevin Ertel
   Modified by: Ayeda OKambawa (23-03-2025) - [This script is based on the enfuseAdvanced script found in the Darktable repository, but I've modified the UpdateAISargs function to make it short input file names by name. This modification is crucial for focus stacking.]
