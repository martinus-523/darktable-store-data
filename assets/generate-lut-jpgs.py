...
Usage:
  generate-lut-jpgs.py                 # everything (skips up-to-date files)
  generate-lut-jpgs.py --filter sensia --raw portrait
  generate-lut-jpgs.py --jobs 4 --force
"""
import argparse
import json
import sqlite3
