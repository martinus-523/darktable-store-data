...
Usage:
  generate-style-webps.py              # everything (skips images that already exist)
  generate-style-webps.py --filter kajili --raw portrait
  generate-style-webps.py --jobs 4 --force   # regenerate even if the image exists
"""
import argparse
import base64
import sqlite3
